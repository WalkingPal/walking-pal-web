		...
		<div className={styles.OurStory}>
			...
			<div className={styles.story2}>
				...
				<div className={styles.typo2}>
					<Typography variant="h5">
						You will be glad to hear that you are not alone there are many
						people out there too who do feel the same. WalkingPal is the
						antidote to all those problems of our-s, it joins people like us who
						have a similar problem so that we can complete the journey easily
						together.{" "}
					</Typography>
				</div>
			</div>
			...
			<div className={styles.story3}>
				...
				<div className={styles.typo3}>
					<Typography variant="h5">
						By making walking more fun and enjoyable it-s a great way to
						complete the last mile which is both cheap (free actually) and
						eco-friendly. Oh, and it-s good for your health too. It-s a great
						way to connect and meet new people, make new friends, relationships
						To explore and talk about the local food, places & culture that too
						completing your journey at the same time while walking together.
					</Typography>
				</div>
			</div>
		</div>
